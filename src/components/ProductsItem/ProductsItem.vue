            ...
            <div class="product-item__avialability">
                <div class="product-item__price">
                    <div :class="['product-item__price-item', {'new': book.oldPrice}]">
                        <span class="product-item__price-normal">{{ book.price }}</span><span class="product-item__curency-normal">₴</span>
                    </div>
                    <div v-if="book.oldPrice" class="product-item__price-item">
                        <span class="product-item__price-old">{{ book.oldPrice }}</span><span class="product-item__curency-old">₴</span>
                    </div>
                </div>
